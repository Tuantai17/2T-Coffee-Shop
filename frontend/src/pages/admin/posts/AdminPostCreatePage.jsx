  ...
  useEffect(() => {
    const loadCategories = async () => {
      try {
        ...
        toast.error("Khong the tai danh muc bai viet.");
      }
    };
  ...
  const submitForm = async (status) => {
    ...
    try {
      ...
      if (
        ...
        toast.error("Khong the luu bai viet.");
      }
    } finally {
      setSubmitting(false);
    }
  ...
  return (
    <AdminLayout>
      <div className="d-flex justify-content-between align-items-center mb-4">
        <h2 className="mb-0">Them bai viet moi</h2>
            ...
            <div className="card-body">
              ...
              <div className="mb-3">
                ...
                <small className="text-muted">
                  He thong tu sinh slug tu tieu de, ban van co the sua lai.
                </small>
              </div>
